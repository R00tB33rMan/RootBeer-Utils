package com.rootbeerutils.main.appleskin.helpers;
import net.minecraft.resources.Identifier;

public class TextureHelper
{
    public static final Identifier MOD_ICONS = Identifier.fromNamespaceAndPath("rootbeerutils", "textures/icons.png");
    public static final Identifier HUNGER_OUTLINE_SPRITE = Identifier.fromNamespaceAndPath("rootbeerutils", "tooltip_hunger_outline.png");
